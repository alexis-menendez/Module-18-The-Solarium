...
![Home Page](https://github.com/alexis-menendez/Module-18-The-Solarium/blob/main/Assets/18-mern-homework-demo-01.gif?raw=true)


The user can save books by clicking "Save This Book!" under each search result, as shown in the following animation:

![Search Results](https://github.com/alexis-menendez/Module-18-The-Solarium/blob/main/Assets/18-mern-homework-demo-02.gif?raw=true)

A user can view their saved books on a separate page, as shown in the following animation:

![Saved Books](https://github.com/alexis-menendez/Module-18-The-Solarium/blob/main/Assets/18-mern-homework-demo-03.gif?raw=true)
